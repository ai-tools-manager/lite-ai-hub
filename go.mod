module lite_ai_hub // (Или то, как называется ваш модуль)
...
// ЭТОТ БЛОК РЕШАЕТ ВСЕ КОНФЛИКТЫ
// Он взят напрямую из go.mod KEDA v2.14.0
replace (
	// Блок для Prometheus (решает v0.0.0-...)
	...
	// Блок для Kubernetes (решает v4/v6)
